...
pedometer = window.webapis.motion;
 ...
 function getPedometerData(pedometerInfo) {
     var pData = {
         ...
         /* deltaCalorie: pedometerInfo.cumulativeCalorie - lastData.calorie,
         deltaDistance: pedometerInfo.cumulativeDistance - lastData.distance,
     	 deltaRunStep: pedometerInfo.cumulativeRunStepCount - lastData.runStep,
     	 deltaTotalStep: pedometerInfo.cumulativeTotalStepCount - lastData.totalStep,
     	 deltaWalkStep: pedometerInfo.cumulativeWalkStepCount - lastData.walkStep */
     };
